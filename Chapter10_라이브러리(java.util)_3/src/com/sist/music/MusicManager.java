...
public class MusicManager {
	...
	static
	{
		try
		{
			...
			// 곡명
			Elements title=doc.select("table.list-wrap td.into a.title");
			// 가수명
			Elements singer=doc.select("table.list-wrap td.into a.artist");
			// 앨범명
			Elements album=doc.select("table.list-wrap td.into a.albumtitle");
