...
import com.sist.vo.*;
import com.sist.manager.*; // 사용자 정의
...
public class BoardListPanel extends JPanel implements ActionListener, MouseListener{
	...
	public BoardListPanel(ControllPanel cp)
	{
		...
		table.setFont(new Font("맑은 고딕",Font.PLAIN,14)); // 게시판 글 폰트 크기
    	...
    	table.addMouseListener(this); // this => 처리하는 메소드 위치 => 클래스 내부
    	boardList();
	}
...
//				JOptionPane.showMessageDialog(this, no);
				...
				// 화면 출력 시 => 데이터형 없음(문자열 출력)
				/*
				 * 	String => String.ValueOf() => 일반 데이터형(int...와 같은 기본형)
				 * 	Object => toString()
				 */
